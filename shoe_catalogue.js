...
function myFunction() {
    ...
    if (shoeColor.value !== "") { //if the user selected a color
        if (shoeSize.value !== "") { // if the user selected a shoe size
            ...
            searched = shoes.filter(colorFilter);
        } // if the user didn't select shoe size, create a new list with only shoe color
    }
    if (shoeBrand.value !== "") {
        if (shoeColor.value !== "" || shoeSize.value !== "") { //selected size or color
            ...
            searched = shoes.filter(brandFilter);
        } // if the user select only shoe brand, create a new list with only shoe color
    }
